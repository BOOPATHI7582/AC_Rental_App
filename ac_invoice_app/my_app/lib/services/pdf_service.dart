...
class PdfService {
  ...
  static Future<Uint8List> buildInvoicePdf({
    ...
    if (settings.signaturePath != null &&
        File(settings.signaturePath!).existsSync()) {
      signature = pw.MemoryImage(
        File(settings.signaturePath!).readAsBytesSync(),
      );
    }
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  if (s.tagline.isNotEmpty)
                    pw.Text(s.tagline, style: const pw.TextStyle(fontSize: 8)),
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  if (c.address.isNotEmpty)
                    pw.Text(c.address, style: const pw.TextStyle(fontSize: 8)),
  ...
  static pw.Widget _totalsAndBankRow(
    Invoice inv,
    CompanySettings s,
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    'A/c Holder: ${s.accountHolderName}',
                    style: const pw.TextStyle(fontSize: 8),
                  ),
                ],
              ),
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.Text(
            numberToIndianWords(inv.totalAmount),
            style: const pw.TextStyle(fontSize: 8),
          ),
        ],
      ),
  ...
  static pw.Widget _termsAndSignatureRow(
    CompanySettings s,
    pw.MemoryImage? signature,
  ) {
    return pw.Table(
            ...
            pw.Container(
              ...
              child: pw.Column(
                children: [
                  ...
                  pw.SizedBox(height: 4),
                  if (signature != null)
                    pw.Image(signature, height: 60, fit: pw.BoxFit.contain)
                  else
